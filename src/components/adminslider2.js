...
export default function AdminSlider2() {
    ...
    const handleAdd = async () => {
        ...
        try {
          const response = await fetch("http://unn-w20017219.newnumyspace.co.uk/ic3/insertpartners", {
            method: 'POST',
            body: formData,
            headers: {
      ...
      const handleDelete = async (id) => {
        ...
        try {
          const response = await fetch("http://unn-w20017219.newnumyspace.co.uk/ic3/deletepartners", {
            method: 'POST',
            body: formData,
