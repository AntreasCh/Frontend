            ...
            return (
                <div className="card1" key={value.news_id}>
                    ...
                    <div className="update">
                        <Link to={"/resources/news-and-insights/" + value.news_id + "/" + value.news_title + "/update-card"} path_title={path_title} className="linkCard">
                            <div className="position2">
                                <button className="updateButton">
                                    <i className="fa-regular fa-pen-to-square"></i> Update Card
                                </button>
                            </div>
                        </Link>
                    </div>
                    <div className="delete">
                        {<DeleteCard path="news-and-insights/delete/?news_id=" id={value.news_id} length={filteredCards.length} />}
                    </div>
                </div>
            );
        });
        ...
        listOfCards = filteredCards.slice(startIndex, endIndex).map((value) => {
            return (
                <div className="card1" key={value.relevant_id}>
                    ...
                    <div className="update">
                        <Link to={"/resources/relevant-news-stories/" + value.relevant_id + "/" + value.relevant_title + "/update-card"} path_title={path_title} className="linkCard">
                            <div className="position2">
                                <button className="updateButton">
                                    <i className="fa-regular fa-pen-to-square"></i> Update Card
                                </button>
                    ...
                    <div className="delete">
                        {<DeleteCard path="relevant-news-stories/delete/?relevant_id=" id={value.relevant_id} length={filteredCards.length} />}
                    </div>
                </div>
            );
        });
        ...
        listOfCards = filteredCards.slice(startIndex, endIndex).map((value) => {
            return (
                <div className="card2" key={value.industry_id}>
                    ...
                    <div className="update">
                        <Link to={"/resources/industry-reports/" + value.industry_id + "/" + value.industry_title + "/update-card"} path_title={path_title} className="linkCard">
                            <div className="position2">
                                <button className="updateButton">
                                    <i className="fa-regular fa-pen-to-square"></i> Update Card
                                </button>
                    ...
                    <div className="delete">
                        {<DeleteCard path="industry-reports/delete/?industry_id=" id={value.industry_id} length={filteredCards.length} />}
                    </div>
                </div>
            );
        });
    ...
    return (
        <div>
            ...
            <div className="cardsSection">
                ...
                {searchSection}
                {sortSection}
                <Link to={"/resources/" + path_title + "/add-new-card"} path_title={path_title} className="linkCard">
                    <div className="position2">
