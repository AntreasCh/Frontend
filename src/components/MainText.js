    ...
    const listOfText = text.map((value) => {
        return (
            <div key={value.main_id}>
                ...
                <Link to={"/community-and-network/update-community-and-network/" + value.main_id} className="linkMainText">
                    <div className="position4">
                        <button className="updateBtnMainText">
                            <i className="fa-regular fa-pen-to-square"></i> Update Text
                        </button>
                    </div>
                </Link>
            </div>
